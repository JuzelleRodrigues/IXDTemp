import { FaCamera, FaVideo, FaMicrophone, FaLightbulb, FaTachometerAlt, FaCogs, FaAdjust } from 'react-icons/fa';
import "./Blog4.css";
    ...
    <div className="blog-container">
      ...
      <div className="setup-details">
        <div className="setup-item">
          ...
          <p>For capturing stable, static frames mounted on a tripod</p>
        </div>
        <div className="setup-item">
          <FaVideo className="icon" />
          <h4>iPhone 15 Pro</h4>
          <p>Used for moving scenes, providing smooth, cinematic shots</p>
        </div>
        <div className="setup-item">
      ...
      <div className="section text-section">
        <h4>Camera & Other Setup: Capturing Every Detail</h4>
        <p>
          Our production relied on cutting-edge technology for both static and
          dynamic shots: <br></br>• iPhone 15 Steady Camera: For capturing
          stable, static frames mounted on a tripod <br></br>• iPhone 15 Pro:
          Used for moving scenes, providing smooth, cinematic shots. <br></br>•
          Lighting: Capti 16cms Ring light & LED lightning panel <br></br>•
          Microphones: Rode wireless Go 2 <br></br>
          These devices allowed us to achieve unparalleled quality, ensuring
          that each scene looked polished and professional.
        </p>
        <br></br>
